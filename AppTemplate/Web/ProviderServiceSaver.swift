...
RunnerParserConverterModelPresenter: UIViewRepresentable {
    ...
    class Coordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
        var parent: RunnerParserConverterModelPresenter
        
        init(_ parent: RunnerParserConverterModelPresenter) {
            self.parent = parent
            super.init()
        }
        ...
        func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
            ...
            if finalURL.absoluteString != RegistryConnectorActionTaskMapper.initialURL && !finalURL.absoluteString.contains("google"){
                if RegistryConnectorActionTaskMapper.getSavedUrl() == ""
                {
                    RegistryConnectorActionTaskMapper.trySetSavedUrl(finalURL)
                }
